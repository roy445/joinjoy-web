...
CREATE TABLE "honor_items" (
	...
	"obtain_config" jsonb DEFAULT '{}'::jsonb,
	"is_purchasable" boolean DEFAULT true NOT NULL,
	"is_free" boolean DEFAULT false NOT NULL,
	"is_activity_only" boolean DEFAULT false NOT NULL,
	"is_holiday_only" boolean DEFAULT false NOT NULL,
	"is_time_limited_sale" boolean DEFAULT false NOT NULL,
	"is_time_limited_use" boolean DEFAULT false NOT NULL,
	"starts_at" timestamp,
	"ends_at" timestamp,
...
--> statement-breakpoint
CREATE TABLE "honor_settings" (
	"id" serial PRIMARY KEY NOT NULL,
	"max_reward_bonus_percent" integer DEFAULT 30 NOT NULL,
	"updated_by" integer,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "honor_transactions" (
	"id" serial PRIMARY KEY NOT NULL,
	"user_id" integer NOT NULL,
	"item_id" integer,
...
CREATE TABLE "users" (
	...
	"j_coins" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "honor_equipments" ADD CONSTRAINT "honor_equipments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_equipments" ADD CONSTRAINT "honor_equipments_item_id_honor_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."honor_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_items" ADD CONSTRAINT "honor_items_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_ownerships" ADD CONSTRAINT "honor_ownerships_item_id_honor_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."honor_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_ownerships" ADD CONSTRAINT "honor_ownerships_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_settings" ADD CONSTRAINT "honor_settings_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_transactions" ADD CONSTRAINT "honor_transactions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_transactions" ADD CONSTRAINT "honor_transactions_item_id_honor_items_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."honor_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "honor_transactions" ADD CONSTRAINT "honor_transactions_actor_id_users_id_fk" FOREIGN KEY ("actor_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
